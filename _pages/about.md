...
My dissertation is examining the relationship between cannabis use and access on prescription opioid use and other related outcomes among recently-injured workers in WA. I will be using a combination of survey and administative claims data, geocoding and creating spatial metrics, and more! Advised by [Isaac Rhew](https://epi.washington.edu/faculty/rhew-isaac/), my aims are: 
